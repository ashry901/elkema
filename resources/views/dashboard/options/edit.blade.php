                                    ...
                                    <form class="form"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="product_id"
                                                            ...
                                                            <optgroup label="Please Choose Product">
                                                                @if($products && $products -> count() > 0)
                                                                    @foreach($products as $product)
                                                                        <option value="{{$product->id}}"
                                                                            @if($product->id == $option->product->id) selected @endif>
                                                                            {{$product->name}}
                                                                        </option>
                                                                    @endforeach
                                                                @endif
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Choose Attributes</label>
                                                        <select name="attribute_id"
                                                                class="select2 form-control">
                                                            <optgroup label="Please Choose Attribute">
                                                                @if($attributes && $attributes -> count() > 0)
                                                                    @foreach($attributes as $attribute)
                                                                        <option value="{{$attribute->id}}"
                                                                            @if($attribute->id == $option->attribute->id) selected @endif>
                                                                            {{$attribute->name}}
                                                                        </option>
                                                                    @endforeach
                                                                @endif
