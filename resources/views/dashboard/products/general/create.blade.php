...
{{--                                                </div>--}}
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Product Description</label>
                                            ...
                                            <div class="row" >
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Choose Categoty</label>
                                                        <select name="categories[]" class="select2 form-control" multiple>
                                                            <optgroup label="Please Choose Section">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="tags[]" class="select2 form-control" multiple>
                                                            <optgroup label="please Choose Tags">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="projectinput1">Choose Brand</label>
