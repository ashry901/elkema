            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    ...
                    <img class="brand-logo"
                            ...
                            {{-- src="{{asset('cpanel/metronic/dist/assets/media/logos/logo-light.png')}}" --}}
                            src="{{asset('ashry/backend/app-assets/images/logo/uslogo2.png')}}">
                    <h3 class="brand-text">Ashry Admin</h3>
                    </a>
                </li>
                                ...
                                <div id="mega-menu-carousel-example">
                                    <div>
                                        <img class="rounded img-fluid mb-1"
                                                src="{{asset('cpanel/metronic/app-assets/images/slider/slider-2.png')}}"
                                                alt="First slide">
                                                <a class="news-title mb-0"
                                                    href="#">
                                                    Poster Frame PSD
                                                </a>
                                        ...
                                        <ul>
                                            <li>
                                                <a class="dropdown-item"
                                                    ...
                                                    <i class="ft-file"></i> Page layouts & Templates
                                                </a>
                                            </li>

                                            <li>
                                                <a href="#">
                                                    <i class="ft-align-left"></i> Multi level menu
                                                </a>
                                                <ul>
                                                    <li><a class="dropdown-item" href="#"><i class="la la-bookmark-o"></i>  Second level</a></li>

                                                    <li>
                                                        <a href="#"><i class="la la-lemon-o"></i> Second level menu</a>
                                                        <ul>
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="color-palette-primary.html">
                                                    <i class="ft-camera"></i> Color palette system
                                                </a>
                                            </li>

                                            <li>
                                                <a class="dropdown-item" href="sk-2-columns.html">
                                                    <i class="ft-edit"></i> Page starter kit
                                                </a>
                                            </li>

                                            <li>
                                                <a class="dropdown-item" href="changelog.html">
                                                    <i class="ft-minimize-2"></i> Change log
                                                </a>
                                            </li>

                                            <li>
                                                <a class="dropdown-item" href="#">
                                                    <i class="la la-life-ring"></i> Customer support center
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-language nav-item">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                            ...
                            <a class="dropdown-item" href="#">
                                <i class="flag-icon flag-icon-fr"></i> Arabic
                            </a>
                            --}}
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link"
                            ...
                            <span class="avatar avatar-online">
                                <img src="{{asset('ashry/backend/app-assets/images/portrait/small/thumbs-up.jpg')}}" alt="avatar">
                                <i></i>
                            </span>
                        </a>
                            ...
                            <li class="scrollable-container media-list w-100">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="avatar avatar-sm avatar-online rounded-circle">
                                                <img src="cpanel/metronic/app-assets/images/portrait/small/avatar-s-19.png"
                                                        alt="avatar"><i></i>
                                            </span>
                                        </div>
                                ...
                                <a href="#">
                                    <div class="media">
                                        <div class="media-left">
                                            ...
                                            <img src="cpanel/metronic/app-assets/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="#">
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="avatar avatar-sm avatar-online rounded-circle">
                                                <img src="cpanel/metronic/app-assets/images/portrait/small/avatar-s-3.png"
                                                        alt="avatar"><i></i>
                                            </span>
                                        </div>
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <span class="avatar avatar-sm avatar-away rounded-circle">
                                                <img src="cpanel/metronic/app-assets/images/portrait/small/avatar-s-6.png"
                                                alt="avatar"><i></i>
                                            </span>
                                        </div>
                                        <div class="media-body">
